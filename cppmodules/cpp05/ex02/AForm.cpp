#include "AForm.hpp"
#include "Bureaucrat.hpp"	// Needed for Bureaucrat::getGrade()
...
/*
	Copy constructor.
	Copies the state of another AForm.
*/
...
/*
	beSigned():
	- If the form is already signed, no state change is needed.
	- If the bureaucrat grade is high enough (<= required grade), the form becomes signed.
