...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/06 09:39:11 by nryser            #+#    #+#             */
/*   Updated: 2024/08/07 20:40:42 by nryser           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
These fractals are calculated using the pixel coordinates.
The complex number c is derived directly from the pixel coordinates.

Julia:
Julia sets use a fixed complex number c for each pixel, which can be
controlled by the mouse position for interactive manipulation.

If is_julia_lock is true, the Julia fractal uses the fixed values
*/
